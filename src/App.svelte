		...
		<section class="info">
			...
			<p class="small">
				I'm using SvelteJS to handle interactivity and state; <strong>
					...
					<br>
					<a href="https://github.com/Punith-KK/">Source code is in the repository</a>.
			</p>
		</section>
	</header>
